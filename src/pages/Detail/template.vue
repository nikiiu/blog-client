<template>
  <div id="detail">
    <section class="user-info">
      <img src="https://picx.zhimg.com/v2-6ed527cf5869be3604eebca1f04709be_r.jpg?source=1940ef5c" alt="" class="avatar">
      <h3>前端异步大揭秘</h3>
      <p><router-link to="/user">萍萍不躺平</router-link> 发布于3天前</p>
    </section>
